  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-950 via-purple-950 to-gray-900 animate-gradient-move">
      ...
      >
        ...
        <h2 ref={headerRef} className="text-3xl font-bold font-playfair tracking-wide text-white text-center mb-6 antialiased animate-gradient-text">Create your account</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <Input
              ...
              required
              className="mt-1 focus:ring-2 focus:ring-green-500 focus:border-green-400 transition-all duration-200 bg-gradient-to-r from-blue-950/60 via-purple-950/60 to-gray-900/60 text-white placeholder:text-blue-300 border border-blue-800/60 shadow-md rounded-lg"
            />
          </div>
          <div>
          ...
          <Button
            ref={buttonRef}
            type="submit"
            className="w-full bg-gradient-to-r from-green-600 to-purple-600 hover:from-purple-600 hover:to-green-600 focus:ring-4 focus:ring-green-400/40 text-white font-semibold py-2 rounded-xl transition-all duration-300 hover:scale-105 focus:scale-102 active:scale-98 shadow-lg relative overflow-hidden group"
